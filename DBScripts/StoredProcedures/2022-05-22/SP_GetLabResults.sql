...
BEGIN
    ...
    SELECT O.*, P.Name AS [PatientName], P.Guardian AS [PatientGuardian], B.Name as BranchName,B.Address AS [BranchAddress],B.Phone AS [BranchPhone], T.Name AS [TechnicianName], C.Name AS [ConsultantName], Test.Name AS [LabTestName]  FROM [LabResult] O
