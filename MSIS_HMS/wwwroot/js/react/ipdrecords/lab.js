...
const OrderForm = (props) => {
    ...
    useEffect(() => {
        $('#labModel').on('hidden.bs.modal', function (e) {
            /* clearForm();*/
            setStatus('');
            setError('');
        })
    ...
    return (
        <div className="row">
            <div className="col-xs-12">
                {<button type="button" className="btn btn-click btn-primary gradient-blue pull-right" data-toggle="modal" data-target="#labModel">Add Lab</button>
            ...
            <div className="modal fade" id="labModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div className="modal-body">
                            <form style={{ height: "500px" }}>
                                <div className="col-md-12 form-group">
                                    ...
                                    <div className="col-xs-6 form-group">
                                        <label className="form-label" for="Name">LabOrderNo</label>
                                        <span className="desc">*</span>
                                        <div className="controls">
...
const rootElement = document.getElementById('lab_root')
