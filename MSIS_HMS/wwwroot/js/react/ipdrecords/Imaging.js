...
const OrderForm = (props) => {
    ...
    const [labOrderTests, setLabOrderTests] = useState(_imgOrderTests);
    ...
    const GetLabOrder = () => {
        debugger;
        $.ajax({
            url: `/IPDRecords/GetImgOrder?iPDRecordId=${ipdRecordId}&date=${date}`,
            type: 'get',
            success: function (res) {
    ...
    const onSave = () => {
        debugger;
        $.ajax({
            url: `/ipdrecords/AddImagingOrderTest`,/*?labOrderTests=${ labOrderTests } && PatientId=${ patient } && VoucherNo=${ voucherNo }*/
            type: 'post',
            data: { imgOrderTests: labOrderTests, patientId: patient, voucherNo: voucherNo, subtotal: total, tax: tax, discount: discount, date: date, iPDRecordId: ipdRecordId },
            success: function (res) {
                GetLabOrder();
            }
        });
    ...
    return (
        <div className="row">
            <div className="col-xs-12">
                {<button type="button" className="btn btn-click btn-primary gradient-blue pull-right" data-toggle="modal" data-target="#imgModel">Add Imaging</button>
                    ...
                    <tbody>
                        {
                            ...
                            iPDLabs.map((ipdL, index) => {
                                console.log("iPDLabs=", ipdL.voucherNo);
                                return (
                                    <React.Fragment>
                                        ...
                                        {ipdL.imagingOrderTests.map((item) => {
                                            return (
                                                <tr>
                                                    <td></td>
                            ...
                            <form style={{ height: "500px" }}>
                                <div className="col-md-12 form-group">
                                    ...
                                    <div className="col-xs-6 form-group">
                                        ...
                                        <span className="desc">*</span>
                                        <div className="controls">
                                            <input type="text" className="form-control" name={`VoucherNo`} onChange={(e) => setVoucherNo(e.target.value)} value={voucherNo} />
...
const rootElement = document.getElementById('img_root')
