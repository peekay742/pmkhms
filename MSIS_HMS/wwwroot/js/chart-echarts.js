...
jQuery(function ($) {
    ...
    CRYPTOKIT_SETTINGS.dashboardEcharts = function () {
        ...
        if ($("#browser_type").length) {
            ...
            $.ajax({
                url: `/Dashboard/GetPharmacyOrdercount`,
                type: 'get',
                success: function (res) {
                    ...
                    option = {
                        ...
                        series: [{
                            name: 'Total Orders', type: 'line', smooth: true, symbol: 'none', symbolSize: 2, showAllSymbol: true, itemStyle: {
                                normal: {
        ...
        /*-------------- LabOrder --------------*/
        if ($("#browser_type_lab").length) {
            // Initialize after dom ready

            debugger;
            var labOrderChart = echarts.init(document.getElementById('browser_type_lab'));
            $.ajax({
                url: `/Dashboard/GetLabOrdercount`,
                type: 'get',
                success: function (res) {
                    var orders = [];
                    var months = [];
                    ...
                    // Load data into the ECharts instance 
                    labOrderChart.setOption(option);
                }
            });

        }
        /*-------------- Monthly Income --------------*/
        if ($("#browser_type_admin").length) {
            // Initialize after dom ready
            var incomeChart = echarts.init(document.getElementById('browser_type_admin'));
            $.ajax({
                ...
                success: function (res) {
                    ...
                    option = {
                        ...
                        series: [{
                            name: 'Total Amount', type: 'line', smooth: true, symbol: 'none', symbolSize: 2, showAllSymbol: true, itemStyle: {
                                normal: {
                                    color: '#e77512', borderWidth: 4, borderColor: '#e77512', areaStyle: {
                                        color: '#e77512', type: 'default'
                                    }
        ...
        /*-------------- IPD ---------------*/
        if ($("#browser_type_ipd").length) {
            // Initialize after dom ready
            var incomeChart = echarts.init(document.getElementById('browser_type_ipd'));
            $.ajax({
                url: `/Dashboard/GetMonthlyAdmittedPatient`,
                type: 'get',
                success: function (res) {
                    var orders = [];
                    var months = [];
                    ...
                    option = {
                        ...
                        series: [{
                            name: 'Total Patients', type: 'line', smooth: true, symbol: 'none', symbolSize: 2, showAllSymbol: true, itemStyle: {
                                normal: {
                                    color: '#e77512', borderWidth: 4, borderColor: '#e77512', areaStyle: {
                                        color: '#e77512', type: 'default'
                                    }
        ...
        /*-------------- Inventory ---------------*/
        if ($("#browser_type_purchase").length) {
            // Initialize after dom ready

            var myChart = echarts.init(document.getElementById('browser_type_purchase'));

            $.ajax({
                url: `/Dashboard/GetMonthlyPurchaseOrder`,
                type: 'get',
                success: function (res) {
                    var orders = [];
                    var months = [];
        ...
        /*-------------- Operation Threater ---------------*/
        if ($("#browser_type_operation").length) {
            // Initialize after dom ready

            var myChart = echarts.init(document.getElementById('browser_type_operation'));

            $.ajax({
                url: `/Dashboard/GetMonthlyOT`,
                type: 'get',
                success: function (res) {
                    var orders = [];
                    var months = [];
                    ...
                    option = {
                        ...
                        series: [{
                            name: 'Total Operations', type: 'line', smooth: true, symbol: 'none', symbolSize: 2, showAllSymbol: true, itemStyle: {
                                normal: {
                                    color: '#e77512', borderWidth: 4, borderColor: '#e77512', areaStyle: {
                                        color: '#e77512', type: 'default'
                                    }
