...
namespace MSIS_HMS.Controllers
{
    public class BranchTransfersController : Controller
    {
        ...
        public BranchTransfersController(UserManager<ApplicationUser> userManager, ApplicationDbContext context, IWarehouseTransferRepository warehouseTransferRepository, IBranchService branchService, IWarehouseRepository warehouseRepository)
        {
        ...
        {
            ViewData["Branches"] = new SelectList(_branchService.GetAll(),"Id","Name");
            ...
            ViewData["ToWarehouses"] = new SelectList(_warehouseRepository.GetAll(),"Id", "Name", warehouseTransfer?.ToWarehouseId);
        }
        ...
        public IActionResult Create()
      {
            ...
            warehouseTransfer.BranchId = _branchService.GetBranchIdByUser() ?? 0;
        ...
        public IActionResult GetWareHousesByBranchId(int branchId)
        {
            var wareHouses = new SelectList(_warehouseRepository.GetAll(branchId), "Id", "Name");
            return Json(wareHouses);
        }

        private List<WarehouseItem> GetWarehouseItemForUpdate(WarehouseTransfer warehouseTransfer, string type) // type = from / to (increase item to warehoue and reduce item from warehouse)
        {
